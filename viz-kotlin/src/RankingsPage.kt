...
class RankingsPage : BaseRankingsPage() {
    ...
    private fun insertInstructions() {
        ...
        page.append("\t<h2>The 2025 competition is coming soon!</h2>\n")
        page.append("\t<ol>\n")
        ...
        page.append("\t\t<li>The winner in the company competition will have the most stars by <span class=\"bestTime\">11:59 PM on December 18</span>.</li>")
        page.append("\t\t<li>Last year, 13 people earned every star. Ties are broken by the <i>lowest median daily time</i> (in other words, the average of your 6th and 7th fastest daily time out of 12 if you finish every puzzle).</li>\n")
